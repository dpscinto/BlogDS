namespace BlogDS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BlogDS.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(BlogDS.Models.ApplicationDbContext context)
        {
